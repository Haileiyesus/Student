...
urlpatterns = [
    ...
    path('add_students/',HodViews.add_student, name="add_students"),
    ...
    path('edit_login_type/',HodViews.edit_login_type, name="edit_login_type"),
    path('edit_login_type_save/',HodViews.edit_login_type_save, name="edit_login_type_save"),
    ...
    path('add_number_student/',HodViews.add_number_student, name="add_number_student"),
    path('add_number_student_save/',HodViews.add_number_student_save, name="add_number_student_save"),
    path('delete_number_student/<section_id>',HodViews.delete_number_student, name="delete_number_student"),
    ...
    path('student_activate/',StudentViews.student_activate, name="student_activate"),
    path('student_activate_save/',StudentViews.student_activate_save, name="student_activate_save"),
]
