...
class Students(models.Model):
    ...
    family_phone_no = models.CharField(max_length=50)
    family_city = models.CharField(max_length=50)
    relation = models.CharField(max_length=50)
    family_adress = models.CharField(max_length=50)
    first_student_name = models.CharField(max_length=50)
    last_student_name = models.CharField(max_length=50)
...
class StudentActivate(models.Model):
    id = models.AutoField(primary_key=True)
    student_id = models.ForeignKey(Students, on_delete=models.CASCADE)
...
class LoginType(models.Model):
    ...
    result_type = models.BooleanField(default=False)
    activate_type = models.BooleanField(default=False)
    insert_type = models.BooleanField(default=False)
